...
print(Mobile.fp)
Mobile.fp = "No"  # if we want we can change the class variable value inside as well outside the class.
print(Mobile.fp)
...
Company.is_fp()  # accessing the class method using object name
