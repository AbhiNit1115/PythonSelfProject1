# Accessor Methods:  This method is used to access or read the data of the variables. This method does not
# modifies data in the variable(s) and is also known as "getter method" e.g.
