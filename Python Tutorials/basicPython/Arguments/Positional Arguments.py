...
# Here the position matters e.g. if i want output as name = abhsihek and age = 25 then i have to pass first
# abhishek and then 25
details("abhishek", 25)
# In case if I reverse the order i.e. first age = 25 then name = abhsihek then my output would not
# come as expected.
details(25, "abhishek")
