...
result = ''.join(['{0} {1} '.format(k, v) for k, v in emp.items()])
print(result)
...
# Updating a Dictionary: If we mention a key which is already exists in the dictionary then value gets updated
# instead of adding a new item. The newly added item can be placed anywhere in dictionary as it's unordered.
emp['class'] = "12 B"
print("After adding new value:", emp)
print()
