# When more tha one method with the same name is defined in the same class, it's called method overloading
...
# get error, so we need to make addition function to perform multiple tasks like addition with 2 numbers
