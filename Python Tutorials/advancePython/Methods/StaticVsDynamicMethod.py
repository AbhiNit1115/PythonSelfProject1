...
# Unlike instance and class method static method gets no implicit first argument (like a regular function).
...
# Use static methods when you don't need the class or instance arguments, but the function is related to the
...
# other class or static methods, or perhaps itself as a constructor. (You wouldn't hardcode the class so
