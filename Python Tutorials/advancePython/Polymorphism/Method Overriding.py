# If we write method with same name in both class i.e. parent as well as child class then the parent class
# method is not available to the child class. In this case only child class method object is accessible
# which means child class method is replacing parent class method.
